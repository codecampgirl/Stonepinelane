		...
		<div class="content">
			<?php while ( have_posts() ): the_post(); ?>
				...
				<div class="social-btns">  <!-- populate or remove as many of these as you want -->
					<a href="https://twitter.com/mctrebo" class="soc-icon tw"></a>
					<!-- <a href="" class="soc-icon fb"></a> -->
					<a href="https://www.linkedin.com/in/monikatrebo" class="soc-icon ln"></a>
					<!-- <a href="" class="soc-icon db"></a> -->
					<!-- <a href="" class="soc-icon gh"></a> -->
					<a href="https://www.instagram.com/mctrebo/" class="soc-icon in"></a>
				</div>
